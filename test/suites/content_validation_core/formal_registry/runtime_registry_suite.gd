...
func test_formal_character_validator_registry_runtime_contract() -> void:
	_assert_legacy_result(_test_formal_character_validator_registry_runtime_contract(_harness))

func test_formal_character_baseline_manifest_id_contract() -> void:
	_assert_legacy_result(_test_formal_character_baseline_manifest_id_contract(_harness))

func test_formal_character_baseline_descriptor_error_contract() -> void:
	_assert_legacy_result(_test_formal_character_baseline_descriptor_error_contract(_harness))
...
func test_formal_character_runtime_registry_ignores_delivery_field_contract() -> void:
	_assert_legacy_result(_test_formal_character_runtime_registry_ignores_delivery_field_contract(_harness))

func test_formal_character_runtime_registry_ignores_pair_interaction_catalog_contract() -> void:
	_assert_legacy_result(_test_formal_character_runtime_registry_ignores_pair_interaction_catalog_contract(_harness))
