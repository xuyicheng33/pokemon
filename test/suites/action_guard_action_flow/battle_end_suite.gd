...
func test_action_failed_post_start_target_missing() -> void:
	_assert_legacy_result(_test_action_failed_post_start_target_missing(_harness))

func test_double_faint_reason_preserved() -> void:
	_assert_legacy_result(_test_double_faint_reason_preserved(_harness))

func test_battle_end_system_chain() -> void:
	_assert_legacy_result(_test_battle_end_system_chain(_harness))
