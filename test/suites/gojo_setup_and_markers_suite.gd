...
func test_gojo_content_and_setup_contract() -> void:
	_assert_legacy_result(_test_gojo_content_and_setup_contract(_harness))

func test_gojo_first_turn_mp_contract() -> void:
	_assert_legacy_result(_test_gojo_first_turn_mp_contract(_harness))

func test_gojo_ao_hit_contract() -> void:
	_assert_legacy_result(_test_gojo_ao_hit_contract(_harness))

func test_gojo_ao_miss_contract() -> void:
	_assert_legacy_result(_test_gojo_ao_miss_contract(_harness))

func test_gojo_aka_hit_contract() -> void:
	_assert_legacy_result(_test_gojo_aka_hit_contract(_harness))

func test_gojo_aka_miss_contract() -> void:
	_assert_legacy_result(_test_gojo_aka_miss_contract(_harness))

func test_gojo_marker_switch_lifecycle_contract() -> void:
	_assert_legacy_result(_test_gojo_marker_switch_lifecycle_contract(_harness))

func test_gojo_marker_refresh_contract() -> void:
	_assert_legacy_result(_test_gojo_marker_refresh_contract(_harness))
