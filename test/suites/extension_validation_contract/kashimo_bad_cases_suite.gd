...
func test_formal_kashimo_validator_bad_case_contract() -> void:
	_assert_legacy_result(_test_formal_kashimo_validator_bad_case_contract(_harness))

func test_formal_kashimo_validator_kyokyo_bad_case_contract() -> void:
	_assert_legacy_result(_test_formal_kashimo_validator_kyokyo_bad_case_contract(_harness))

func test_formal_kashimo_validator_charge_mark_bad_case_contract() -> void:
	_assert_legacy_result(_test_formal_kashimo_validator_charge_mark_bad_case_contract(_harness))

func test_formal_kashimo_validator_thunder_resist_surface_bad_case_contract() -> void:
	_assert_legacy_result(_test_formal_kashimo_validator_thunder_resist_surface_bad_case_contract(_harness))

func test_formal_kashimo_validator_water_leak_counter_fixed_damage_bad_case_contract() -> void:
	_assert_legacy_result(_test_formal_kashimo_validator_water_leak_counter_fixed_damage_bad_case_contract(_harness))
