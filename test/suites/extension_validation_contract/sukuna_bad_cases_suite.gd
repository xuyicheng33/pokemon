...
func test_formal_sukuna_validator_bad_case_contract() -> void:
	_assert_legacy_result(_test_formal_sukuna_validator_bad_case_contract(_harness))

func test_formal_sukuna_validator_reverse_bad_case_contract() -> void:
	_assert_legacy_result(_test_formal_sukuna_validator_reverse_bad_case_contract(_harness))

func test_formal_sukuna_validator_regen_surface_bad_case_contract() -> void:
	_assert_legacy_result(_test_formal_sukuna_validator_regen_surface_bad_case_contract(_harness))
