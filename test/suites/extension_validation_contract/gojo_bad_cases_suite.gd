...
func test_formal_gojo_validator_bad_case_contract() -> void:
	_assert_legacy_result(_test_formal_gojo_validator_bad_case_contract(_harness))

func test_formal_gojo_validator_reverse_bad_case_contract() -> void:
	_assert_legacy_result(_test_formal_gojo_validator_reverse_bad_case_contract(_harness))

func test_formal_gojo_validator_murasaki_cleanup_bad_case_contract() -> void:
	_assert_legacy_result(_test_formal_gojo_validator_murasaki_cleanup_bad_case_contract(_harness))

func test_formal_gojo_validator_action_lock_surface_bad_case_contract() -> void:
	_assert_legacy_result(_test_formal_gojo_validator_action_lock_surface_bad_case_contract(_harness))

func test_formal_gojo_validator_action_lock_stacking_bad_case_contract() -> void:
	_assert_legacy_result(_test_formal_gojo_validator_action_lock_stacking_bad_case_contract(_harness))
