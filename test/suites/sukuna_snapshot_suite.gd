...
func test_sukuna_unit_snapshot_contract() -> void:
	_assert_legacy_result(_test_sukuna_unit_snapshot_contract(_harness))

func test_sukuna_skill_snapshot_contract() -> void:
	_assert_legacy_result(_test_sukuna_skill_snapshot_contract(_harness))

func test_sukuna_effect_snapshot_contract() -> void:
