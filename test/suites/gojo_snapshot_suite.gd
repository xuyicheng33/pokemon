...
func test_gojo_unit_snapshot_contract() -> void:
	_assert_legacy_result(_test_gojo_unit_snapshot_contract(_harness))

func test_gojo_skill_snapshot_contract() -> void:
	_assert_legacy_result(_test_gojo_skill_snapshot_contract(_harness))

func test_gojo_effect_snapshot_contract() -> void:
	_assert_legacy_result(_test_gojo_effect_snapshot_contract(_harness))
