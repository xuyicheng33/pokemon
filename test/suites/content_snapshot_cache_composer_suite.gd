...
func test_content_snapshot_cache_composer_stats_contract() -> void:
	_assert_legacy_result(_test_content_snapshot_cache_composer_stats_contract(_harness))

func test_content_snapshot_cache_signature_tracks_file_content_contract() -> void:
	_assert_legacy_result(_test_content_snapshot_cache_signature_tracks_file_content_contract(_harness))

func test_content_snapshot_cache_signature_tracks_external_resource_dependency_contract() -> void:
	_assert_legacy_result(_test_content_snapshot_cache_signature_tracks_external_resource_dependency_contract(_harness))

func test_content_snapshot_cache_signature_tracks_shared_dependency_contract() -> void:
	_assert_legacy_result(_test_content_snapshot_cache_signature_tracks_shared_dependency_contract(_harness))

func test_content_snapshot_cache_signature_tracks_runtime_registry_contract() -> void:
	_assert_legacy_result(_test_content_snapshot_cache_signature_tracks_runtime_registry_contract(_harness))
