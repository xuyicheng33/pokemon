...
func test_multihit_skill_per_segment_mod_runtime_contract() -> void:
	_assert_legacy_result(_test_multihit_skill_per_segment_mod_runtime_contract(_harness))

func test_multihit_skill_stops_after_faint_contract() -> void:
	_assert_legacy_result(_test_multihit_skill_stops_after_faint_contract(_harness))

func test_multihit_skill_top_level_power_ignored_contract() -> void:
	_assert_legacy_result(_test_multihit_skill_top_level_power_ignored_contract(_harness))
