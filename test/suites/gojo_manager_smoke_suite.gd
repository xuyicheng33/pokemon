...
func _test_gojo_manager_smoke_contract(harness) -> Dictionary:
	return _smoke_helper.run_named_case(harness, _case_specs, "test_gojo_manager_smoke_contract")


func _test_gojo_manager_domain_public_contract(harness) -> Dictionary:
	return _smoke_helper.run_named_case(harness, _case_specs, "test_gojo_manager_domain_public_contract")
