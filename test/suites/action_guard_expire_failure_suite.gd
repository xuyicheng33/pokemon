...
func test_effect_expire_invalid_terminates_turn_immediately() -> void:
	_assert_legacy_result(_test_effect_expire_invalid_terminates_turn_immediately(_harness))

func test_field_expire_invalid_terminates_turn_immediately() -> void:
	_assert_legacy_result(_test_field_expire_invalid_terminates_turn_immediately(_harness))
