...
func _test_sukuna_manager_smoke_contract(harness) -> Dictionary:
	return _smoke_helper.run_named_case(harness, _case_specs, "test_sukuna_manager_smoke_contract")

func _test_sukuna_manager_domain_lifecycle_public_contract(harness) -> Dictionary:
	return _smoke_helper.run_named_case(harness, _case_specs, "test_sukuna_manager_domain_lifecycle_public_contract")
