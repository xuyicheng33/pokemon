...
func test_legal_action_public_id_contract() -> void:
	_assert_legacy_result(_test_legal_action_public_id_contract(_harness))

func test_initial_selection_mp_contract() -> void:
	_assert_legacy_result(_test_initial_selection_mp_contract(_harness))

func test_selection_adapters_public_id_contract() -> void:
	_assert_legacy_result(_test_selection_adapters_public_id_contract(_harness))

func test_validator_internal_id_backfill_contract() -> void:
	_assert_legacy_result(_test_validator_internal_id_backfill_contract(_harness))

func test_field_creator_public_id_contract() -> void:
	_assert_legacy_result(_test_field_creator_public_id_contract(_harness))
...
func _test_selection_adapters_public_id_contract(_unused_harness) -> Dictionary:
