...
func test_kashimo_manager_public_contracts() -> void:
	_assert_legacy_result(_test_kashimo_manager_public_contracts(_harness))


func _test_kashimo_manager_public_contracts(harness) -> Dictionary:
	_ensure_suite_state()
