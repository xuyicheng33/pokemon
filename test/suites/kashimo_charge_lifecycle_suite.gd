...
func test_kashimo_negative_charge_overflow_and_roll_contract() -> void:
	_assert_legacy_result(_test_kashimo_negative_charge_overflow_and_roll_contract(_harness))

func test_kashimo_positive_charge_overflow_and_switch_clear_contract() -> void:
	_assert_legacy_result(_test_kashimo_positive_charge_overflow_and_switch_clear_contract(_harness))

func test_kashimo_negative_charge_switch_clear_contract() -> void:
	_assert_legacy_result(_test_kashimo_negative_charge_switch_clear_contract(_harness))
