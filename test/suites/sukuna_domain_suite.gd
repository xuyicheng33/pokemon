...
func test_sukuna_domain_expire_chain_path() -> void:
	_assert_legacy_result(_test_sukuna_domain_expire_chain_path(_harness))

func test_sukuna_domain_break_chain_path() -> void:
	_assert_legacy_result(_test_sukuna_domain_break_chain_path(_harness))

func test_sukuna_domain_break_on_faint_path() -> void:
	_assert_legacy_result(_test_sukuna_domain_break_on_faint_path(_harness))

func test_sukuna_field_accuracy_override_path() -> void:
	_assert_legacy_result(_test_sukuna_field_accuracy_override_path(_harness))

func test_sukuna_domain_failed_clash_no_field_no_buff_no_expire_burst_contract() -> void:
	_assert_legacy_result(_test_sukuna_domain_failed_clash_no_field_no_buff_no_expire_burst_contract(_harness))
