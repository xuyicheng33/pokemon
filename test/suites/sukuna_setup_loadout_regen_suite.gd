...
func test_sukuna_default_loadout_contract() -> void:
	_assert_legacy_result(_test_sukuna_default_loadout_contract(_harness))

func test_sukuna_matchup_regen_runtime_path() -> void:
	_assert_legacy_result(_test_sukuna_matchup_regen_runtime_path(_harness))

func test_sukuna_matchup_bst_includes_max_mp_contract() -> void:
	_assert_legacy_result(_test_sukuna_matchup_bst_includes_max_mp_contract(_harness))
