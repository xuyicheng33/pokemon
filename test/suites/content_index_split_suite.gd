...
func test_content_index_split_validation_contract() -> void:
	_assert_legacy_result(_test_content_index_split_validation_contract(_harness))

func test_content_snapshot_recursive_contract() -> void:
	_assert_legacy_result(_test_content_snapshot_recursive_contract(_harness))

func test_content_snapshot_curated_contract() -> void:
	_assert_legacy_result(_test_content_snapshot_curated_contract(_harness))

func test_content_snapshot_recursive_missing_dir_contract() -> void:
	_assert_legacy_result(_test_content_snapshot_recursive_missing_dir_contract(_harness))
