...
func test_combat_type_direct_damage_and_logs() -> void:
	_assert_legacy_result(_test_combat_type_direct_damage_and_logs(_harness))

func test_combat_type_formula_damage_paths() -> void:
	_assert_legacy_result(_test_combat_type_formula_damage_paths(_harness))

func test_combat_type_default_and_recoil_paths() -> void:
	_assert_legacy_result(_test_combat_type_default_and_recoil_paths(_harness))

func test_recoil_ratio_runtime_config_contract() -> void:
	_assert_legacy_result(_test_recoil_ratio_runtime_config_contract(_harness))
