...
func test_ultimate_points_regular_skill_gain_contract() -> void:
	_assert_legacy_result(_test_ultimate_points_regular_skill_gain_contract(_harness))

func test_ultimate_points_non_regular_switch_preserve_contract() -> void:
	_assert_legacy_result(_test_ultimate_points_non_regular_switch_preserve_contract(_harness))

func test_ultimate_points_ultimate_legality_and_reset_contract() -> void:
	_assert_legacy_result(_test_ultimate_points_ultimate_legality_and_reset_contract(_harness))
