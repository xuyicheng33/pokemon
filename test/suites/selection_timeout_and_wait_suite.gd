...
func test_timeout_wait_path() -> void:
	_assert_legacy_result(_test_timeout_wait_path(_harness))

func test_resource_forced_default_path() -> void:
	_assert_legacy_result(_test_resource_forced_default_path(_harness))

func test_wait_allowed_non_mp_blocked_path() -> void:
	_assert_legacy_result(_test_wait_allowed_non_mp_blocked_path(_harness))

func test_manual_wait_no_damage_path() -> void:
	_assert_legacy_result(_test_manual_wait_no_damage_path(_harness))
