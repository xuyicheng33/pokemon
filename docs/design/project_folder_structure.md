...
|`config/`|工程级静态配置；当前包含 `formal_character_sources/`、导出的 `formal_character_manifest.json / formal_character_capability_catalog.json`、`formal_registry_contracts.json / sample_matchup_catalog.json / demo_replay_catalog.json`|
...
|`tests/support`|`gdUnit4` suite 公共基类、桥接资源、测试 harness、公共构造器与固定案例 support|
