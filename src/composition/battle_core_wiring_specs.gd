...
const WIRING_SPECS := [
    ...
    {"owner": "field_apply_service", "dependency": "field_apply_context_resolver", "source": "field_apply_context_resolver"},
    {"owner": "field_apply_service", "dependency": "field_apply_conflict_service", "source": "field_apply_conflict_service"},
