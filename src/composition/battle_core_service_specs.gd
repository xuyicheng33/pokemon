...
const SERVICE_DESCRIPTORS := [
	...
	{"slot": "action_cast_mp_service", "script": preload("res://src/battle_core/actions/action_cast_mp_service.gd")},
	{"slot": "action_cast_target_service", "script": preload("res://src/battle_core/actions/action_cast_target_service.gd")},
	{"slot": "action_cast_hit_service", "script": preload("res://src/battle_core/actions/action_cast_hit_service.gd")},
	{"slot": "action_cast_segment_service", "script": preload("res://src/battle_core/actions/action_cast_segment_service.gd")},
	{"slot": "action_cast_effect_dispatch_service", "script": preload("res://src/battle_core/actions/action_cast_effect_dispatch_service.gd")},
