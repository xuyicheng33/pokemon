extends RefCounted
class_name GojoFormalCharacterBaseline

func unit_contract() -> Dictionary:
	return {
		"label": "formal[gojo].unit",
		"snapshot_label": "gojo",
		"unit_id": "gojo_satoru",
		"fields": {
			"display_name": "五条悟",
...
func effect_contracts() -> Array[Dictionary]:
	return [
		...
		{
			"label": "formal[gojo].murasaki_burst",
		...
		{
			"label": "formal[gojo].domain_followup",
		...
		{
			"label": "formal[gojo].reverse_ritual.effect",
		...
		{
			"label": "formal[gojo].mugen.effect",
...
func domain_field_contract() -> Dictionary:
	return {
		"label": "formal[gojo].domain_field",
