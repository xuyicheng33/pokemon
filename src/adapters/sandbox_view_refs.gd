...
func bind(root: Control) -> void:
	...
	character_scroll = root.get_node("RootMargin/MainColumn/SelectPanel/SelectContent/CharacterScroll") as ScrollContainer
	character_cards = root.get_node("RootMargin/MainColumn/SelectPanel/SelectContent/CharacterScroll/CharacterCards") as GridContainer
	...
	primary_buttons = root.get_node("RootMargin/MainColumn/ActionPanel/ActionContent/PrimaryButtons") as Container
	switch_label = root.get_node("RootMargin/MainColumn/ActionPanel/ActionContent/SwitchLabel") as Label
	switch_buttons = root.get_node("RootMargin/MainColumn/ActionPanel/ActionContent/SwitchButtons") as Container
	utility_buttons = root.get_node("RootMargin/MainColumn/ActionPanel/ActionContent/UtilityButtons") as Container
