extends RefCounted
class_name TurnExpiryDecrementHelper
...
func decrement_effect_instances_and_log(battle_state: BattleState, content_index: BattleContentIndex, trigger_name: String, owner_unit_ids: Array, cause_event_id: String) -> bool:
...
func decrement_rule_mods_and_log(battle_state: BattleState, trigger_name: String, cause_event_id: String) -> void:
