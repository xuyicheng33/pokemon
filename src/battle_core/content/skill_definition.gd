...
@export var execute_target_hp_ratio_lte: float = 0.0
@export var execute_required_total_stacks: int = 0
@export var execute_self_effect_ids: PackedStringArray = PackedStringArray()
@export var execute_target_effect_ids: PackedStringArray = PackedStringArray()
@export var damage_segments: Array[Resource] = []
