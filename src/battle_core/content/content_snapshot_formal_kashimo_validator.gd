...
const KashimoUnitPassiveContractsScript := preload("res://src/battle_core/content/content_snapshot_formal_kashimo_unit_passive_contracts.gd")
const KashimoSkillEffectContractsScript := preload("res://src/battle_core/content/content_snapshot_formal_kashimo_skill_effect_contracts.gd")
const KashimoUltimateDomainContractsScript := preload("res://src/battle_core/content/content_snapshot_formal_kashimo_ultimate_domain_contracts.gd")
