...
func _validate_feedback_strike(content_index, errors: Array) -> void:
    ...
    var skill_definition = content_index.skills.get("kashimo_feedback_strike", null)
...
func _validate_thunder_resist(content_index, errors: Array) -> void:
    ...
    var effect_definition = content_index.effects.get("kashimo_thunder_resist", null)
...
func _validate_water_leak_counter(content_index, errors: Array) -> void:
    ...
    var effect_definition = content_index.effects.get("kashimo_water_leak_counter_listener", null)
    if effect_definition == null:
        return
    var payload = _extract_single_payload(
        errors,
...
func _validate_amber_contract(content_index, errors: Array) -> void:
    ...
    var unit_definition = content_index.units.get("kashimo_hajime", null)
    ...
    var amber_effect = content_index.effects.get("kashimo_amber_self_transform", null)
