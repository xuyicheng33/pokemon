    ...
    for unit_id in units.keys():
        ...
        if not unit_definition.candidate_skill_ids.is_empty():
            ...
            for candidate_skill_id in unit_definition.candidate_skill_ids:
                ...
                if not skills.has(normalized_candidate_skill_id):
...
func validate_setup(battle_setup) -> Array:
    ...
    if battle_setup == null:
        ...
        return errors
    var format_definition = battle_formats.get(String(battle_setup.format_id).strip_edges(), null)
...
func _validate_regular_skill_loadout_overrides(errors: Array, side_setup, format_definition) -> void:
    ...
    for raw_slot_index in side_setup.regular_skill_loadout_overrides.keys():
        ...
        var unit_definition = units.get(unit_definition_id, null)
