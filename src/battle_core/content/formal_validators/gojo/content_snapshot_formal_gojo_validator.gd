...
const GojoUnitPassiveContractsScript := preload("res://src/battle_core/content/formal_validators/gojo/content_snapshot_formal_gojo_unit_passive_contracts.gd")
const GojoSkillEffectContractsScript := preload("res://src/battle_core/content/formal_validators/gojo/content_snapshot_formal_gojo_skill_effect_contracts.gd")
const GojoUltimateDomainContractsScript := preload("res://src/battle_core/content/formal_validators/gojo/content_snapshot_formal_gojo_ultimate_domain_contracts.gd")
