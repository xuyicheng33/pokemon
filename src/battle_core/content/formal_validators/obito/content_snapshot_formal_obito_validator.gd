...
const ObitoUnitPassiveContractsScript := preload("res://src/battle_core/content/formal_validators/obito/content_snapshot_formal_obito_unit_passive_contracts.gd")
const ObitoSkillEffectContractsScript := preload("res://src/battle_core/content/formal_validators/obito/content_snapshot_formal_obito_skill_effect_contracts.gd")
const ObitoUltimateDomainContractsScript := preload("res://src/battle_core/content/formal_validators/obito/content_snapshot_formal_obito_ultimate_domain_contracts.gd")
