extends RefCounted
class_name PublicIdAllocatorSuite

const PublicIdAllocatorScript := preload("res://src/battle_core/turn/public_id_allocator.gd")

func register_tests(runner, failures: Array[String], harness) -> void:
    runner.run_test("public_id_allocator_label_sequence", failures, Callable(self, "_test_public_id_allocator_label_sequence"))
    runner.run_test("public_id_allocator_runtime_contract", failures, Callable(self, "_test_public_id_allocator_runtime_contract").bind(harness))
