extends RefCounted
class_name SkillExecuteContractSuite
...
func register_tests(runner, failures: Array[String], harness) -> void:
    runner.run_test("skill_execute_runtime_contract", failures, Callable(self, "_test_skill_execute_runtime_contract").bind(harness))
    runner.run_test("skill_execute_fallback_runtime_contract", failures, Callable(self, "_test_skill_execute_fallback_runtime_contract").bind(harness))
    runner.run_test("skill_execute_validation_contract", failures, Callable(self, "_test_skill_execute_validation_contract").bind(harness))
