...
const ContentValidationPayloadDispatchSuiteScript := preload("res://tests/suites/content_validation_core/payload_dispatch_suite.gd")
...
func register_tests(runner, failures: Array[String], harness) -> void:
    ...
    ContentValidationPayloadDispatchSuiteScript.new().register_tests(runner, failures, harness)
