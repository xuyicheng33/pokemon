...
func register_tests(runner, failures: Array[String], harness) -> void:
    runner.run_test("turn_scope_active_and_field", failures, Callable(self, "_test_turn_scope_active_and_field").bind(harness))
    ...
    runner.run_test("manual_switch_breaks_field_before_replacement_enter", failures, Callable(self, "_test_manual_switch_breaks_field_before_replacement_enter").bind(harness))
    runner.run_test("faint_replace_breaks_field_before_replacement_enter", failures, Callable(self, "_test_faint_replace_breaks_field_before_replacement_enter").bind(harness))
...
func _configure_sample_focus_field_break_test(content_index, prefix: String) -> void:
    ...
    field_enter_effect.trigger_names = PackedStringArray(["on_enter"])
