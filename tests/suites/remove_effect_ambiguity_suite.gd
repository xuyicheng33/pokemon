extends RefCounted
class_name RemoveEffectAmbiguitySuite
...
func register_tests(runner, failures: Array[String], harness) -> void:
    runner.run_test("remove_effect_ambiguity_contract", failures, Callable(self, "_test_remove_effect_ambiguity_contract").bind(harness))
