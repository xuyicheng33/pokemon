...
const CapabilityCatalogSuiteScript := preload("res://tests/suites/content_validation_core/formal_registry/capability_catalog_suite.gd")
...
func register_tests(runner, failures: Array[String], harness) -> void:
	...
	CapabilityCatalogSuiteScript.new().register_tests(runner, failures, harness)
