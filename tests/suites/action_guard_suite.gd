...
const OnReceiveActionHitSuiteScript := preload("res://tests/suites/on_receive_action_hit_suite.gd")
...
func register_tests(runner, failures: Array[String], harness) -> void:
	...
	OnReceiveActionHitSuiteScript.new().register_tests(runner, failures, harness)
