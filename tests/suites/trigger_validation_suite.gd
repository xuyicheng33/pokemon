extends RefCounted
class_name TriggerValidationSuite
...
func register_tests(runner, failures: Array[String], harness) -> void:
    runner.run_test("skill_effect_trigger_validation", failures, Callable(self, "_test_skill_effect_trigger_validation").bind(harness))
    runner.run_test("field_lifecycle_trigger_validation", failures, Callable(self, "_test_field_lifecycle_trigger_validation").bind(harness))
    runner.run_test("apply_field_success_trigger_validation", failures, Callable(self, "_test_apply_field_success_trigger_validation").bind(harness))
