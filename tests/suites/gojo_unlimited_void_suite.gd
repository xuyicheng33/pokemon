...
func register_tests(runner, failures: Array[String], harness) -> void:
	...
	runner.run_test("gojo_unlimited_void_expire_removes_field_buff_contract", failures, Callable(self, "_test_gojo_unlimited_void_expire_removes_field_buff_contract").bind(harness))
	runner.run_test("gojo_unlimited_void_break_removes_field_buff_contract", failures, Callable(self, "_test_gojo_unlimited_void_break_removes_field_buff_contract").bind(harness))
