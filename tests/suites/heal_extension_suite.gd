...
func register_tests(runner, failures: Array[String], harness) -> void:
    runner.run_test("missing_hp_percent_heal_runtime_contract", failures, Callable(self, "_test_missing_hp_percent_heal_runtime_contract").bind(harness))
    runner.run_test("incoming_heal_final_mod_blocks_heal_contract", failures, Callable(self, "_test_incoming_heal_final_mod_blocks_heal_contract").bind(harness))
    runner.run_test("heal_extension_validation_contract", failures, Callable(self, "_test_heal_extension_validation_contract").bind(harness))
