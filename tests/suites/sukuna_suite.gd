...
const SukunaManagerBlackboxSuiteScript := preload("res://tests/suites/sukuna_manager_blackbox_suite.gd")
...
func register_tests(runner, failures: Array[String], harness) -> void:
    ...
    SukunaManagerBlackboxSuiteScript.new().register_tests(runner, failures, harness)
