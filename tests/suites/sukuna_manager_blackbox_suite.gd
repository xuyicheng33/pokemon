...
func register_tests(runner, failures: Array[String], harness) -> void:
	...
	runner.run_test("sukuna_manager_hatsu_public_contract", failures, Callable(self, "_test_sukuna_manager_hatsu_public_contract").bind(harness))
	runner.run_test("sukuna_manager_teach_love_public_contract", failures, Callable(self, "_test_sukuna_manager_teach_love_public_contract").bind(harness))
...
func _test_sukuna_manager_teach_love_public_contract(harness) -> Dictionary:
	...
	var mp_before_switch := int(before_switch.get("current_mp", -1))
