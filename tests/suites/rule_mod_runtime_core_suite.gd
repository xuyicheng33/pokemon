...
func _test_rule_mod_multi_source_grouping_paths(harness) -> Dictionary:
    ...
    if core.rule_mod_service.create_instance(regen_payload_a, {"scope": "unit", "id": p1_active.unit_instance_id}, battle_state, "regen_source_a", 0, p1_active.base_speed, null, "effect_regen_a") == null:
    ...
    if core.rule_mod_service.create_instance(regen_payload_b, {"scope": "unit", "id": p1_active.unit_instance_id}, battle_state, "regen_source_b", 0, p1_active.base_speed, null, "effect_regen_b") == null:
    ...
    if core.rule_mod_service.resolve_mp_regen_value(battle_state, p1_active.unit_instance_id, 0) != 5:
    ...
    if core.rule_mod_service.create_instance(regen_payload_replace, {"scope": "unit", "id": p1_active.unit_instance_id}, battle_state, "regen_source_a_replace", 0, p1_active.base_speed, null, "effect_regen_c") == null:
    ...
    if core.rule_mod_service.resolve_mp_regen_value(battle_state, p1_active.unit_instance_id, 0) != 7:
    ...
    if core.rule_mod_service.create_instance(regen_payload_none, {"scope": "unit", "id": p1_active.unit_instance_id}, battle_state, "regen_source_none", 0, p1_active.base_speed, null, "effect_regen_d") == null:
        return harness.fail_result("stacking=none grouped mp_regen should return existing instance instead of null")
    if _count_rule_mod_instances(p1_active, "mp_regen") != 2 or core.rule_mod_service.resolve_mp_regen_value(battle_state, p1_active.unit_instance_id, 0) != 7:
    ...
    if core.rule_mod_service.create_instance(incoming_payload_a, {"scope": "unit", "id": p2_active.unit_instance_id}, battle_state, "accuracy_source_a", 0, p2_active.base_speed, null, "effect_accuracy_a") == null:
    ...
    if core.rule_mod_service.create_instance(incoming_payload_b, {"scope": "unit", "id": p2_active.unit_instance_id}, battle_state, "accuracy_source_b", 0, p2_active.base_speed, null, "effect_accuracy_b") == null:
    ...
    if core.rule_mod_service.resolve_incoming_accuracy(battle_state, p2_active.unit_instance_id, 95) != 80:
    ...
    if core.rule_mod_service.create_instance(incoming_payload_replace, {"scope": "unit", "id": p2_active.unit_instance_id}, battle_state, "accuracy_source_replace", 0, p2_active.base_speed, null, "effect_accuracy_c") == null:
    ...
    if core.rule_mod_service.resolve_incoming_accuracy(battle_state, p2_active.unit_instance_id, 95) != 78:
