...
func _test_ultimate_points_regular_skill_gain_contract(harness) -> Dictionary:
	...
	if not _helper.has_ultimate_point_delta(core.battle_logger.event_log, 1, 1):
	...
	if _helper.has_ultimate_point_delta(core.battle_logger.event_log, 0, 3):
...
func _test_ultimate_points_ultimate_legality_and_reset_contract(harness) -> Dictionary:
	...
	if not _helper.has_ultimate_point_delta(core.battle_logger.event_log, -3, 0):
