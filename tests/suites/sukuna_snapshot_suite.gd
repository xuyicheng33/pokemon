...
func _test_sukuna_effect_snapshot_contract(harness) -> Dictionary:
    ...
    var checks: Array[Dictionary] = [
        ...
        {"label": "sukuna_refresh_love_regen duration_mode", "actual": String(regen_payload.duration_mode), "expected": "turns"},
        {"label": "sukuna_refresh_love_regen duration", "actual": int(regen_payload.duration), "expected": 999},
