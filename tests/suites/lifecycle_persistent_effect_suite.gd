extends RefCounted
class_name LifecyclePersistentEffectSuite
...
func register_tests(runner, failures: Array[String], harness) -> void:
    runner.run_test("persistent_effect_and_rule_mod_survive_manual_switch_contract", failures, Callable(self, "_test_persistent_effect_and_rule_mod_survive_manual_switch_contract").bind(harness))
    runner.run_test("persistent_effect_and_rule_mod_clear_on_faint_contract", failures, Callable(self, "_test_persistent_effect_and_rule_mod_clear_on_faint_contract").bind(harness))
