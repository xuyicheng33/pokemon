...
func register_tests(runner, failures: Array[String], harness) -> void:
	...
	runner.run_test("log_event_builder_missing_chain_context_contract", failures, Callable(self, "_test_log_event_builder_missing_chain_context_contract"))
	runner.run_test("log_event_builder_missing_cause_event_id_contract", failures, Callable(self, "_test_log_event_builder_missing_cause_event_id_contract"))
	runner.run_test("turn_selection_resolver_legal_action_service_failure_contract", failures, Callable(self, "_test_turn_selection_resolver_legal_action_service_failure_contract").bind(harness))
	runner.run_test("turn_selection_resolver_failure_is_atomic_contract", failures, Callable(self, "_test_turn_selection_resolver_failure_is_atomic_contract").bind(harness))
	runner.run_test("turn_selection_resolver_command_builder_failure_contract", failures, Callable(self, "_test_turn_selection_resolver_command_builder_failure_contract").bind(harness))
	runner.run_test("legal_action_service_rule_mod_failure_contract", failures, Callable(self, "_test_legal_action_service_rule_mod_failure_contract").bind(harness))
