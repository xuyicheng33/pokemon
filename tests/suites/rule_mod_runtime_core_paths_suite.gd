...
func register_tests(runner, failures: Array[String], harness) -> void:
    ...
    runner.run_test("rule_mod_refresh_updates_source_metadata_contract", failures, Callable(self, "_test_rule_mod_refresh_updates_source_metadata_contract").bind(harness))
...
func _test_rule_mod_refresh_updates_source_metadata_contract(harness) -> Dictionary:
    ...
    var regen_payload = _build_numeric_rule_mod_payload("mp_regen", "add", 2, "regen:refresh_contract")
    ...
    var refreshed_payload = _build_numeric_rule_mod_payload("mp_regen", "add", 7, "regen:refresh_contract")
