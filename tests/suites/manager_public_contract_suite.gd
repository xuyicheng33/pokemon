...
const ManagerFacadeInternalContractSuiteScript := preload("res://tests/suites/manager_facade_internal_contract_suite.gd")
...
func register_tests(runner, failures: Array[String], harness) -> void:
	ManagerFacadeInternalContractSuiteScript.new().register_tests(runner, failures, harness)
