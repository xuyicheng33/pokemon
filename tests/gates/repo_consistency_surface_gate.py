...
ctx.require_contains("README.md", "docs/design/current_development_workflow.md", "README workflow entry")
ctx.require_contains("README.md", "docs/design/current_stage_regression_baseline.md", "README regression baseline entry")
ctx.require_contains("README.md", "tests/sync_formal_registry.sh", "README formal sync entry")
ctx.require_contains("README.md", "config/formal_character_sources/", "README formal source entry")
ctx.require_contains("README.md", "config/formal_character_manifest.json", "README generated manifest entry")
...
ctx.require_contains("tests/README.md", "tests/sync_formal_registry.sh", "tests formal sync entry")
ctx.require_contains("tests/README.md", "formal_character_sources/", "tests formal source entry")
ctx.require_contains("tests/README.md", "check_suite_reachability.sh", "tests suite reachability gate doc")
ctx.require_contains("tests/README.md", "BattleSandbox", "tests sandbox entry doc")
ctx.require_contains("tests/README.md", "tests/run_gdunit.sh", "tests gdUnit entry doc")
ctx.require_contains("tests/README.md", "JUnit XML", "tests gdUnit report wording")
