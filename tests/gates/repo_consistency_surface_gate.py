...
ctx.require_contains("tests/support/formal_character_registry.gd", 'const REGISTRY_PATH := "res://config/formal_character_registry.json"', "formal character registry path")
...
ctx.require_contains("README.md", "config/formal_character_registry.json", "README formal character registry")
