...
var _scene_support = ManualBattleSceneSupportScript.new()
...
func _init() -> void:
	...
	var context_result = _scene_support.build_manual_scene_context(null, BattleSandboxLaunchConfigScript.DEFAULT_BATTLE_SEED, launch_config)
	...
	if controller == null or not controller.has_method("set_replay_frame"):
		...
		var close_error = _scene_support.close_context(context)
	...
	_scene_support.sync_context_from_controller(context)
	...
	var close_result = _scene_support.close_context(context)
