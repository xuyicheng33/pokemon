...
require_contains("docs/design/battle_core_architecture_constraints.md", "220", "architecture early warning threshold")
...
require_contains("tests/check_architecture_constraints.sh", "ARCH_GATE_WARNING", "architecture warning marker")
